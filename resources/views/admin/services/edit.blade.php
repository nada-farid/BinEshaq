...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="breif_summery">{{ trans('cruds.service.fields.breif_summery') }}</label>
                <textarea class="form-control {{ $errors->has('breif_summery') ? 'is-invalid' : '' }}" name="breif_summery" id="breif_summery" required>{{ old('breif_summery', $service->breif_summery) }}</textarea>
                @if($errors->has('breif_summery'))
                    <div class="invalid-feedback">
                        {{ $errors->first('breif_summery') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.breif_summery_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="photo_2">{{ trans('cruds.service.fields.photo_2') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.photo_2_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($service) && $service->photo_2)
      var file = {!! json_encode($service->photo_2) !!}
          this.options.addedfile.call(this, file)
