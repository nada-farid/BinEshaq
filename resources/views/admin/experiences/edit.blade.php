    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.experiences.update", [$experience->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('brief_summary') ? 'is-invalid' : '' }}" name="brief_summary" id="brief_summary" required>{{ old('brief_summary', $experience->brief_summary) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $experience->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('years') ? 'is-invalid' : '' }}" type="number" name="years" id="years" value="{{ old('years', $experience->years) }}" step="1" required>
                @if($errors->has('years'))
                    <div class="invalid-feedback">
                        {{ $errors->first('years') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('projects') ? 'is-invalid' : '' }}" type="number" name="projects" id="projects" value="{{ old('projects', $experience->projects) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_customer') ? 'is-invalid' : '' }}" type="number" name="special_customer" id="special_customer" value="{{ old('special_customer', $experience->special_customer) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('worker') ? 'is-invalid' : '' }}" type="number" name="worker" id="worker" value="{{ old('worker', $experience->worker) }}" step="1" required>
