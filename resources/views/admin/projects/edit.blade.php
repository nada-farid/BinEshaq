    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place') ? 'is-invalid' : '' }}" type="text" name="place" id="place" value="{{ old('place', $project->place) }}" required>
                @if($errors->has('place'))
                    <div class="invalid-feedback">
                        {{ $errors->first('place') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client') ? 'is-invalid' : '' }}" type="text" name="client" id="client" value="{{ old('client', $project->client) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('classification') ? 'is-invalid' : '' }}" type="text" name="classification" id="classification" value="{{ old('classification', $project->classification) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('during') ? 'is-invalid' : '' }}" type="text" name="during" id="during" value="{{ old('during', $project->during) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('breif') ? 'is-invalid' : '' }}" name="breif" id="breif" required>{{ old('breif', $project->breif) }}</textarea>
                @if($errors->has('breif'))
                    <div class="invalid-feedback">
                        {{ $errors->first('breif') }}
                    </div>
