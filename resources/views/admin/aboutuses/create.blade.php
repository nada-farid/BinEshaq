    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.aboutuses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_2') ? 'is-invalid' : '' }}" type="text" name="email_2" id="email_2" value="{{ old('email_2', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instegram') ? 'is-invalid' : '' }}" type="text" name="instegram" id="instegram" value="{{ old('instegram', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('services_text') ? 'is-invalid' : '' }}" name="services_text" id="services_text" required>{{ old('services_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('projects_text') ? 'is-invalid' : '' }}" name="projects_text" id="projects_text" required>{{ old('projects_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('products_text') ? 'is-invalid' : '' }}" name="products_text" id="products_text" required>{{ old('products_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('news_text') ? 'is-invalid' : '' }}" name="news_text" id="news_text" required>{{ old('news_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('contact_text') ? 'is-invalid' : '' }}" name="contact_text" id="contact_text">{{ old('contact_text') }}</textarea>
