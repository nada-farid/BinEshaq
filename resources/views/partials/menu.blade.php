<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('company_development_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.company-developments.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/company-developments") || request()->is("admin/company-developments/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-building c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.companyDevelopment.title') }}
                </a>
            </li>
        @endcan
